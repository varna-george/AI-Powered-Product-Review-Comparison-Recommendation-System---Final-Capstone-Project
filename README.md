...
The DistilBERT sentiment classification model achieved an accuracy of 92.8% on the validation dataset. The model also achieved a precision of 95.86%, recall of 95.75%, and an F1-score of 95.81%, indicating excellent performance in identifying positive and negative product reviews. Early stopping was used to prevent overfitting, and the model converged after approximately 1.4 epochs.
